...
typedef void (*ravbot_mobile_event_callback)(const char* event_name,
                                             const char* payload_json,
                                             void* user_data);
typedef void (*ravbot_mobile_avatar_state_callback)(const char* session_key,
                                                    const char* state,
                                                    void* user_data);
typedef void (*ravbot_mobile_speech_request_callback)(const char* session_key,
                                                      const char* text,
                                                      void* user_data);
typedef void (*ravbot_mobile_speech_interrupt_callback)(const char* session_key,
                                                        void* user_data);
typedef const char* (*ravbot_mobile_capture_control_callback)(
    const char* session_key, bool enabled, void* user_data);
typedef void (*ravbot_mobile_vibrate_callback)(const char* session_key,
                                               int duration_ms,
                                               void* user_data);
typedef const char* (*ravbot_mobile_web_search_callback)(
    const char* session_key, const char* query, int count,
    const char* freshness, void* user_data);
typedef const char* (*ravbot_mobile_web_fetch_callback)(const char* session_key,
                                                        const char* url,
                                                        int max_chars,
                                                        void* user_data);
...
typedef struct ravbot_mobile_device_callbacks {
  ...
  ravbot_mobile_capture_control_callback on_capture_control;
...
bool ravbot_mobile_report_tts_state(ravbot_mobile_engine_t* engine,
                                    const char* session_key, const char* state);
