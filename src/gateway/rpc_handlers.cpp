      ...
      [](const nlohmann::json& /*params*/,
                 ...
                 {{"runtime",
                    ...
                    {"properties",
                     {{"enabled", {{"type", "boolean"}}},
                      {"mode",
                       {{"type", "string"},
                        {"enum",
                         nlohmann::json::array({"local", "remote"})}}},
                      {"foregroundOnly", {{"type", "boolean"}}},
                      {"continuousVision", {{"type", "boolean"}}}}}}},
                  {"models",
                   {{"type", "object"},
                    {"properties",
                     {{"llmModel", {{"type", "string"}}},
                      {"vlmModel", {{"type", "string"}}},
                      {"mmprojModel", {{"type", "string"}}},
                      {"sttModel", {{"type", "string"}}},
                      {"ttsVoice", {{"type", "string"}}},
                      {"useVulkan", {{"type", "boolean"}}}}}}},
                  {"audio",
                   {{"type", "object"},
                    {"properties",
                     {{"autoListen", {{"type", "boolean"}}},
                      {"tapToTalkEnabled", {{"type", "boolean"}}},
                  ...
                  {"vision",
                   {{"type", "object"},
                    {"properties",
                     {{"enabled", {{"type", "boolean"}}},
                      {"sampleFps", {{"type", "number"}, {"minimum", 0.1}}},
                      {"foregroundOnly", {{"type", "boolean"}}},
                      {"persistRawFrames", {{"type", "boolean"}}},
                  ...
                  {"avatar",
                   {{"type", "object"},
                    {"properties",
                     {{"renderer",
                       {{"type", "string"},
                        {"enum", nlohmann::json::array({"face2d"})}}},
        ...
        nlohmann::json ui_hints = {
            ...
            {"mobile.runtime.enabled",
             {{"label", "Enabled"}, {"group", "Mobile Runtime"}}},
            {"mobile.runtime.mode",
             {{"label", "Mode"}, {"group", "Mobile Runtime"}}},
            {"mobile.runtime.foregroundOnly",
             {{"label", "Foreground Only"}, {"group", "Mobile Runtime"}}},
            {"mobile.runtime.continuousVision",
             {{"label", "Continuous Vision"}, {"group", "Mobile Runtime"}}},
            {"mobile.models.llmModel",
             {{"label", "LLM Model"}, {"group", "Mobile Models"}}},
            {"mobile.models.vlmModel",
             {{"label", "VLM Model"}, {"group", "Mobile Models"}}},
            {"mobile.models.mmprojModel",
             {{"label", "MMProj Model"}, {"group", "Mobile Models"}}},
            {"mobile.models.sttModel",
             {{"label", "STT Model"}, {"group", "Mobile Models"}}},
            {"mobile.models.ttsVoice",
             {{"label", "TTS Voice"}, {"group", "Mobile Models"}}},
            {"mobile.models.useVulkan",
             {{"label", "Use Vulkan"}, {"group", "Mobile Models"}}},
            {"mobile.audio.autoListen",
             {{"label", "Auto Listen"}, {"group", "Mobile Audio"}}},
            {"mobile.audio.tapToTalkEnabled",
             {{"label", "Tap To Talk"}, {"group", "Mobile Audio"}}},
            {"mobile.audio.wakeWordEnabled",
             {{"label", "Wake Word"}, {"group", "Mobile Audio"}}},
            {"mobile.audio.bargeInEnabled",
             {{"label", "Barge-in"}, {"group", "Mobile Audio"}}},
            {"mobile.audio.sampleRate",
             {{"label", "Sample Rate"}, {"group", "Mobile Audio"}}},
            {"mobile.vision.enabled",
             {{"label", "Enabled"}, {"group", "Mobile Vision"}}},
            {"mobile.vision.sampleFps",
             {{"label", "Sample FPS"}, {"group", "Mobile Vision"}}},
            {"mobile.vision.foregroundOnly",
             {{"label", "Foreground Only"}, {"group", "Mobile Vision"}}},
            {"mobile.vision.persistRawFrames",
             {{"label", "Persist Raw Frames"}, {"group", "Mobile Vision"}}},
            {"mobile.vision.sceneChangeThreshold",
             {{"label", "Scene Change Threshold"},
              {"group", "Mobile Vision"}}},
            {"mobile.avatar.renderer",
             {{"label", "Renderer"}, {"group", "Mobile Avatar"}}},
            {"mobile.avatar.defaultState",
             {{"label", "Default State"}, {"group", "Mobile Avatar"}}},
            {"mobile.avatar.lipSyncEnabled",
             {{"label", "Lip Sync"}, {"group", "Mobile Avatar"}}},
